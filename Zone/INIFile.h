...
public:
    ...
    const char* Get(std::string section, std::string name, const char* default_value) const;
...
inline const char* INIReader::Get(std::string section, std::string name, const char* default_value) const
{
    std::string key = MakeKey(section, name);
